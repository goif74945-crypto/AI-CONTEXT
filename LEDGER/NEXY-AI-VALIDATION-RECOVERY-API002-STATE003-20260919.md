...
LEDGER-1 | source=GitHub compare | claim=pre-write branch exactly one commit ahead of 78df3506... | proof=e950f113... | risk=low | status=VERIFIED | confidence=1.0
LEDGER-2 | source=Actions 34740944733 | claim=contract/integration discovery failed with zero tests | proof=No test files found exit 1 | risk=high | status=VERIFIED | confidence=1.0
LEDGER-3 | source=target commit ce0e490... | claim=only six authorized files changed in repair commit | proof=e950...ce0e compare | risk=low | status=VERIFIED | confidence=1.0
LEDGER-4 | source=Actions 35448899862 contract | claim=contract suite executes and passes | proof=10 files/91 tests | risk=low | status=VERIFIED | confidence=1.0
LEDGER-5 | source=Actions 35448899862 integration | claim=integration suite executes and passes | proof=71 files/623 pass/1 skip | risk=low | status=VERIFIED | confidence=1.0
LEDGER-6 | source=Actions 35448899862 typecheck | claim=typecheck remains failing without new diagnostics vs baseline | proof=identical 52 error-log entries including exit marker | risk=release-blocking | status=VERIFIED | confidence=1.0
LEDGER-7 | source=Actions 35448899862 evidence | claim=evidence seal verify fails | proof=seal:verify FAILED exit 1 | risk=release-blocking | status=VERIFIED | confidence=1.0
LEDGER-8 | source=Actions 35448899862 deploy | claim=deploy did not execute | proof=Deploy conclusion skipped | risk=none | status=VERIFIED | confidence=1.0
