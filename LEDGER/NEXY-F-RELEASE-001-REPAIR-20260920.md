...
LEDGER-1 | source=authoritative DOC-E snapshot | claim=deploy approval requires E1-E12 proof and engineering/security/migration signoff plus rollback/monitoring verification | status=VERIFIED | confidence=1.0
LEDGER-2 | source=GitHub branch | claim=precondition HEAD was e091fc9c2ab0d963f39d424b732b28254cdc6202 before mutation | status=VERIFIED | confidence=1.0
LEDGER-3 | source=GitHub compare | claim=repair commit 39a857fc changes exactly 3 authorized files | status=VERIFIED | confidence=1.0
LEDGER-4 | source=Actions contract job 106026697671 | claim=targeted 18/18 and contract 110/110 pass | status=VERIFIED | confidence=1.0
LEDGER-5 | source=Actions integration/full/typecheck | claim=integration 629 pass/1 skip, full 766 pass/1 skip, typecheck success | status=VERIFIED | confidence=1.0
LEDGER-6 | source=Actions DOC-C job 106026766693 | claim=DOC-C static gate success and explicitly not release authorization | status=VERIFIED | confidence=1.0
LEDGER-7 | source=runtime artifact 10598649511 | claim=v3, VALIDATION_ONLY, NOT_DEPLOYED, five gate results success | status=VERIFIED | confidence=1.0
LEDGER-8 | source=GitHub compare 39a857fc..8e9adb69 | claim=synthetic PR merge is content-equivalent to source head; changed files=[] | status=VERIFIED | confidence=1.0
LEDGER-9 | source=PR #8 + Actions | claim=PR remains open/draft/unmerged; Deploy skipped; no deployment occurred | status=VERIFIED | confidence=1.0
LEDGER-10 | source=target diff | claim=PASS_LOCKED F-QUEUE-004 files/queue implementation untouched | status=VERIFIED | confidence=1.0
