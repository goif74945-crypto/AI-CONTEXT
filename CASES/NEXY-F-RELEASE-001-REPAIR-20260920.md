...
case_cause: five green CI gates could mint RELEASE_ELIGIBLE without DOC-E E1-E12 proof.
case_impact: CI success could be confused with deployment authorization, violating DOC-E release signoff/rollback/monitoring law.
case_fix: v3 fail-closed generator + independent verifier block + workflow NON_DEPLOYABLE on main push + strong regressions.
regression_status: PR Actions run 35491343876 all required validation jobs green; deploy skipped.
