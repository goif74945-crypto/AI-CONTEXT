...
\ncase_cause: historical committed seal was not revision/run-bound; static gate overclaimed deployability; deploy was a placeholder echo.\ncase_impact: false release evidence or deployment implication could cross a release boundary.\ncase_fix: runtime CI attestation + static-only DOC-C wording + fail-closed provider block.\nregression_status: focused contract tests green; release chain intentionally blocked by typecheck.\n