...
\nFAILURE_ID: NEXY-EVIDENCE-CHAIN-BLOCKED-20260919\ncontext: GitHub Actions run 35454093303.\ncause: F-BUILD-001 typecheck remains red.\nfailed_approach: end-to-end runtime attestation job could not execute because required upstream gate failed.\nrecovery: fix F-BUILD-001 in separate authorized scope, then rerun same release chain.\nboundary: do not weaken needs/dependencies or fabricate runtime evidence.\nprevention: keep release-attestation needs on typecheck+contract+integration+DOC-C.\n