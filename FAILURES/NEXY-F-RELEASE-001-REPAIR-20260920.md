...
FAILURE_ID: NEXY-F-RELEASE-001-RESIDUAL-DOC-E-INCOMPLETE-20260920
context: post-repair state after Actions run 35491343876.
cause: DOC-E E1-E12 complete machine-verifiable authorization model and current proof do not yet exist.
failed_approach: treating five CI gates as sufficient deployment eligibility is prohibited.
recovery: separately implement and verify real E1-E12 evidence/signoff/rollback/monitoring contract under explicit scope.
boundary: do not mint RELEASE_ELIGIBLE, fake evidence, placeholder signoff, merge, or deploy.
prevention: retain v3 generator/verifier fail-closed gates and workflow NON_DEPLOYABLE main-push status until authoritative DOC-E support exists.
